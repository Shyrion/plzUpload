...
define(['lib/CrispyPear/CPDisplayObject'], function(CPDisplayObject) {
	...
	*/
	CPSprite.prototype.add = function (params){
	    ...
	    if (seq.framePerRow == 0) {
	    	console.error("Image smaller than the framesize !");
	    	return;
	    }
	...
	/*
		...
		frameSize					: size of an image of the animation
	*/
	CPSprite.prototype.remove = function (params){
		this.sequences[seqName] && this.sequences.splice(this.sequences.indexOf(seqName), 1);
	}
